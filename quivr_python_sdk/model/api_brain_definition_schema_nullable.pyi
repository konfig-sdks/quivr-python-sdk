...
class ApiBrainDefinitionSchemaNullable(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def required() -> typing.Type['ApiBrainDefinitionSchemaNullableRequired']:
                return ApiBrainDefinitionSchemaNullableRequired
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["required"]) -> 'ApiBrainDefinitionSchemaNullableRequired': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["required"]) -> typing.Union['ApiBrainDefinitionSchemaNullableRequired', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, None, ],
        ...
        required: typing.Union['ApiBrainDefinitionSchemaNullableRequired', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
