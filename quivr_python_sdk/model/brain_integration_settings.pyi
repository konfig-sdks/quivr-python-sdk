...
class BrainIntegrationSettings(
    schemas.DictSchema
):
    """
    ...
    integration_id: MetaOapg.properties.integration_id
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["integration_id", "settings", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["integration_id"]) -> MetaOapg.properties.integration_id: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["integration_id", "settings", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        integration_id: typing.Union[MetaOapg.properties.integration_id, str, ],
