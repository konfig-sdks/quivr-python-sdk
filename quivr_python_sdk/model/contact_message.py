...
class ContactMessage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["customer_email", "content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["customer_email", "content", ], str]):
