...
class UserUpdatableProperties(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["username", "company", "onboarded", "company_size", "usage_purpose", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["username", "company", "onboarded", "company_size", "usage_purpose", ], str]):
