    ...
    async def _aset_default_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/brains/{brain_id}/default',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SetDefaultRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_default(
        self,
        brain_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._set_default_mapped_args(
            brain_id=brain_id,
        )
        return await self._aset_default_oapg(
    ...
    def set_default(
        ...
        return self._set_default_oapg(
            path_params=args.path,
        )

class SetDefault(BaseApi):
    ...
    async def aset_default(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aset_default(
            brain_id=brain_id,
            **kwargs,
        )
        if validate:
    ...
    def set_default(
        ...
        raw_response = self.raw.set_default(
            brain_id=brain_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
