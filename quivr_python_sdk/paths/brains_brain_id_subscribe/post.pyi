...
class BaseApi(api_client.Api):
    ...
    def _brain_handler_mapped_args(
        self,
        brain_id: str,
    ...
    async def _abrain_handler_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/brains/{brain_id}/subscribe',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class BrainHandlerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abrain_handler(
        self,
        brain_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._brain_handler_mapped_args(
            brain_id=brain_id,
        )
        return await self._abrain_handler_oapg(
            body=args.body,
    ...
    def brain_handler(
        ...
        return self._brain_handler_oapg(
            body=args.body,
            path_params=args.path,
        )

class BrainHandler(BaseApi):
    ...
    async def abrain_handler(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abrain_handler(
            brain_id=brain_id,
            **kwargs,
        )
        if validate:
    ...
    def brain_handler(
        ...
        raw_response = self.raw.brain_handler(
            brain_id=brain_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
