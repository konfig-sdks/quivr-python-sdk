...
class BaseApi(api_client.Api):
    ...
    def _remove_user_subscription_mapped_args(
        self,
        brain_id: str,
    ...
    async def _aremove_user_subscription_oapg(
        self,
    ...
    def _remove_user_subscription_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveUserSubscriptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_user_subscription(
        self,
        brain_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_user_subscription_mapped_args(
            brain_id=brain_id,
        )
        return await self._aremove_user_subscription_oapg(
    ...
    def remove_user_subscription(
        ...
        return self._remove_user_subscription_oapg(
            path_params=args.path,
        )

class RemoveUserSubscription(BaseApi):
    ...
    async def aremove_user_subscription(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_user_subscription(
            brain_id=brain_id,
            **kwargs,
        )
        if validate:
    ...
    def remove_user_subscription(
        ...
        raw_response = self.raw.remove_user_subscription(
            brain_id=brain_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
