...
class BaseApi(api_client.Api):
    ...
    def _get_user_invitation_mapped_args(
        self,
        brain_id: str,
    ...
    async def _aget_user_invitation_oapg(
        self,
...
class GetUserInvitationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_invitation(
        self,
        brain_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_user_invitation_mapped_args(
            brain_id=brain_id,
        )
        return await self._aget_user_invitation_oapg(
    ...
    def get_user_invitation(
        ...
        return self._get_user_invitation_oapg(
            path_params=args.path,
        )

class GetUserInvitation(BaseApi):
    ...
    async def aget_user_invitation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_invitation(
            brain_id=brain_id,
            **kwargs,
        )
        if validate:
    ...
    def get_user_invitation(
        ...
        raw_response = self.raw.get_user_invitation(
            brain_id=brain_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
