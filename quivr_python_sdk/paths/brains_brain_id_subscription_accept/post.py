...
class BaseApi(api_client.Api):
    ...
    def _accept_invitation_mapped_args(
        self,
        brain_id: str,
    ...
    async def _aaccept_invitation_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/brains/{brain_id}/subscription/accept',
            auth_settings=_auth,
            headers=_headers,
        )
...
class AcceptInvitationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccept_invitation(
        self,
        brain_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._accept_invitation_mapped_args(
            brain_id=brain_id,
        )
        return await self._aaccept_invitation_oapg(
...
class AcceptInvitation(BaseApi):
    ...
    async def aaccept_invitation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aaccept_invitation(
            brain_id=brain_id,
            **kwargs,
        )
        if validate:
    ...
    def accept_invitation(
        ...
        raw_response = self.raw.accept_invitation(
            brain_id=brain_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
