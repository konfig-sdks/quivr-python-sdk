...
class BaseApi(api_client.Api):
    ...
    def _decline_invitation_mapped_args(
        self,
        brain_id: str,
    ...
    async def _adecline_invitation_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/brains/{brain_id}/subscription/decline',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeclineInvitationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adecline_invitation(
        self,
        brain_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._decline_invitation_mapped_args(
            brain_id=brain_id,
        )
        return await self._adecline_invitation_oapg(
...
class DeclineInvitation(BaseApi):
    ...
    async def adecline_invitation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adecline_invitation(
            brain_id=brain_id,
            **kwargs,
        )
        if validate:
    ...
    def decline_invitation(
        ...
        raw_response = self.raw.decline_invitation(
            brain_id=brain_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
