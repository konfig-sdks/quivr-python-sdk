...
class BaseApi(api_client.Api):
    ...
    def _unregister_handler_mapped_args(
        self,
        brain_id: str,
    ...
    async def _aunregister_handler_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/brains/{brain_id}/unsubscribe',
            auth_settings=_auth,
            headers=_headers,
        )
...
class UnregisterHandlerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunregister_handler(
        self,
        brain_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unregister_handler_mapped_args(
            brain_id=brain_id,
        )
        return await self._aunregister_handler_oapg(
    ...
    def unregister_handler(
        ...
        return self._unregister_handler_oapg(
            path_params=args.path,
        )

class UnregisterHandler(BaseApi):
    ...
    async def aunregister_handler(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunregister_handler(
            brain_id=brain_id,
            **kwargs,
        )
        if validate:
    ...
    def unregister_handler(
        ...
        raw_response = self.raw.unregister_handler(
            brain_id=brain_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
