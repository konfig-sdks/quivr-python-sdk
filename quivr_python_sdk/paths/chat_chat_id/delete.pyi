...
class BaseApi(api_client.Api):
    ...
    def _delete_chat_by_id_mapped_args(
        self,
        chat_id: str,
    ...
    async def _adelete_chat_by_id_oapg(
        self,
...
class DeleteChatByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_chat_by_id(
        self,
        chat_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_chat_by_id_mapped_args(
            chat_id=chat_id,
        )
        return await self._adelete_chat_by_id_oapg(
    ...
    def delete_chat_by_id(
        ...
        return self._delete_chat_by_id_oapg(
            path_params=args.path,
        )

class DeleteChatById(BaseApi):
    ...
    async def adelete_chat_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_chat_by_id(
            chat_id=chat_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_chat_by_id(
        ...
        raw_response = self.raw.delete_chat_by_id(
            chat_id=chat_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
