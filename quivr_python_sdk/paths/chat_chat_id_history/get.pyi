...
from quivr_python_sdk.model.chat_get_history_response import ChatGetHistoryResponse as ChatGetHistoryResponseSchema

from quivr_python_sdk.type.chat_get_history_response import ChatGetHistoryResponse
...
from quivr_python_sdk.pydantic.chat_get_history_response import ChatGetHistoryResponse as ChatGetHistoryResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ChatGetHistoryResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ChatGetHistoryResponse
    ...
    async def _aget_history_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/chat/{chat_id}/history',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetHistory(BaseApi):
    ...
    async def aget_history(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ChatGetHistoryResponsePydantic:
        raw_response = await self.raw.aget_history(
            chat_id=chat_id,
            **kwargs,
        )
        if validate:
            return RootModel[ChatGetHistoryResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ChatGetHistoryResponsePydantic, raw_response.body)
