...
class BaseApi(api_client.Api):
    ...
    def _create_stream_question_handler_mapped_args(
        self,
        question: str,
        chat_id: str,
    ...
    async def _acreate_stream_question_handler_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/chat/{chat_id}/question/stream',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _create_stream_question_handler_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreateStreamQuestionHandlerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_stream_question_handler(
        self,
        question: str,
        chat_id: str,
        model: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._create_stream_question_handler_mapped_args(
            question=question,
            chat_id=chat_id,
            model=model,
        ...
        return await self._acreate_stream_question_handler_oapg(
            body=args.body,
    ...
    def create_stream_question_handler(
        ...
        return self._create_stream_question_handler_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateStreamQuestionHandler(BaseApi):
    ...
    async def acreate_stream_question_handler(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_stream_question_handler(
            question=question,
            chat_id=chat_id,
            model=model,
            temperature=temperature,
    ...
    def create_stream_question_handler(
        ...
        raw_response = self.raw.create_stream_question_handler(
            question=question,
            chat_id=chat_id,
            model=model,
            temperature=temperature,
