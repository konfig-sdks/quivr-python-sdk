...
class BaseApi(api_client.Api):
    ...
    def _get_by_chat_id_mapped_args(
        self,
        chat_id: str,
    ...
    async def _aget_by_chat_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/notifications/{chat_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByChatIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_chat_id(
        self,
        chat_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_by_chat_id_mapped_args(
            chat_id=chat_id,
        )
        return await self._aget_by_chat_id_oapg(
    ...
    def get_by_chat_id(
        ...
        return self._get_by_chat_id_oapg(
            path_params=args.path,
        )

class GetByChatId(BaseApi):
    ...
    async def aget_by_chat_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_chat_id(
            chat_id=chat_id,
            **kwargs,
        )
        if validate:
    ...
    def get_by_chat_id(
        ...
        raw_response = self.raw.get_by_chat_id(
            chat_id=chat_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
