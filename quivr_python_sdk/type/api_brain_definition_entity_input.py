...
class RequiredApiBrainDefinitionEntityInput(TypedDict):
    brain_id: str
...
class OptionalApiBrainDefinitionEntityInput(TypedDict, total=False):
    raw: bool

    jq_instructions: typing.Optional[str]

class ApiBrainDefinitionEntityInput(RequiredApiBrainDefinitionEntityInput, OptionalApiBrainDefinitionEntityInput):
    pass
