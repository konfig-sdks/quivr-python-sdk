...
class RequiredApiBrainDefinitionEntityInputNullable(TypedDict):
    brain_id: str
...
class OptionalApiBrainDefinitionEntityInputNullable(TypedDict, total=False):
    raw: bool

    jq_instructions: typing.Optional[str]

class ApiBrainDefinitionEntityInputNullable(RequiredApiBrainDefinitionEntityInputNullable, OptionalApiBrainDefinitionEntityInputNullable):
    pass
