...
class RequiredApiBrainDefinitionEntityOutput(TypedDict):
    brain_id: str
...
class OptionalApiBrainDefinitionEntityOutput(TypedDict, total=False):
    raw: bool

    jq_instructions: typing.Optional[str]

class ApiBrainDefinitionEntityOutput(RequiredApiBrainDefinitionEntityOutput, OptionalApiBrainDefinitionEntityOutput):
    pass
