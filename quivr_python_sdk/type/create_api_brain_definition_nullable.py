...
class RequiredCreateApiBrainDefinitionNullable(TypedDict):
    method: ApiBrainAllowedMethods

    url: str

class OptionalCreateApiBrainDefinitionNullable(TypedDict, total=False):
...
class CreateApiBrainDefinitionNullable(RequiredCreateApiBrainDefinitionNullable, OptionalCreateApiBrainDefinitionNullable):
    pass
